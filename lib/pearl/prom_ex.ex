defmodule Pearl.PromEx do
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: PearlWeb.Router, endpoint: PearlWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:pearl, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
